...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var allSubscribers, _a, _b, _i, allSubscribers_1, subscriber, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                return [4 /*yield*/, getAllSubscribers()];
            case 1:
                allSubscribers = _c.sent();
                console.log(allSubscribers);
                _b = (_a = console).log;
                return [4 /*yield*/, createNews("Coronavírus", "Vacina", 1589818936000)];
            case 2:
                _b.apply(_a, [_c.sent()]);
                for (_i = 0, allSubscribers_1 = allSubscribers; _i < allSubscribers_1.length; _i++) {
                    subscriber = allSubscribers_1[_i];
...
var getAllSubscribers = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"].get(baseURL + "/subscribers/all")];
            case 1:
                subscribers = _a.sent();
                return [2 /*return*/, subscribers.data.map(function (subscriber) {
                        return {
...
function createNews(title, content, date) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1["default"].put(baseURL + "/news", {
                        title: title,
                        content: content,
                        date: date
                    })];
